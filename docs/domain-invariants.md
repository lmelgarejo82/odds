...
- No se fija una cantidad de seleccionados y un día puede no tener destacados.
- Los resultados reales son la referencia. La primera investigación no selecciona por cuotas.
- Una observación no es una apuesta. No hay stake, balance, beneficio ni pérdida real.
- No se conecta con Apostala ni se comparte la base de otro proyecto.
