...
El dominio no depende de Next.js ni Prisma. La aplicación orquesta casos de uso; infraestructura encapsula persistencia; contratos contiene los límites JSON intercambiables. En B001 no existen conectores de captura.
