...
async function main() {
  try {
    ...
    const fields = [["RUN_COMPLETE",true],["RUN_ID",result.runId],["SPORTS_DATE",args.sportsDate],["RUN_MODE",result.runMode],["FIXTURES_DISCOVERED",result.fixturesDiscovered],["FIXTURES_ELIGIBLE",result.fixturesEligible],["FIXTURES_DEEP_ANALYZED",result.fixturesDeepAnalyzed],["FIXTURES_EXCLUDED",result.fixturesExcluded],["RECOMMENDATIONS",result.recommendations],["STRONG",result.strong],["INTERESTING",result.interesting],["WATCH",result.watch],["PASS",result.pass],["HISTORICAL_CALIBRATION_AVAILABLE",result.historicalCalibrationAvailable],["ODDS_AVAILABLE",result.oddsAvailable],["ODDS_RESPONSE_RECEIVED",result.oddsResponseReceived],["ODDS_EVENTS_RECEIVED",result.oddsEventsReceived],["ODDS_FIXTURES_MATCHED",result.oddsFixturesMatched],["ODDS_MARKETS_MATCHED",result.oddsMarketsMatched],["USABLE_ODDS_AVAILABLE",result.usableOddsAvailable],["MARKET_EVALUATIONS_CREATED",result.marketEvaluationsCreated],["MARKET_VALUE_CALCULATED",result.marketValueCalculated],["TOP_RECOMMENDATION",result.topRecommendation],["API_FOOTBALL_BUDGET",result.apiFootballBudget],["API_FOOTBALL_REQUESTS",result.apiFootballRequests],["ODDS_BUDGET",result.oddsBudget],["ODDS_REQUESTS",result.oddsRequests],["NETWORK_USED",result.networkUsed],["REPLAYED",result.replayed],["AUTOMATED_BETTING",false],["EXIT",0]] as const;
